...
This is why tests of methods that involve floating point numbers often don't check equality but equality within a certain delta.
For example, we could write a test like the following (assuming that we also implement arithmetic methods like Length#-):
