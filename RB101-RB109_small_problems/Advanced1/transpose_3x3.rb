...
So, in this case, matrix[0][2] is 8, and matrix[2][1] is 9. An entire row in the matrix can be referenced by just using one index:
...
##################################################
Input: Nested Arrays
Output: Nested Arrays, transposed
Explicit Rules:
Do not modify the original matrix, return a new one.
Do not used Array#transpose or the Matrix class from the standard library.

Implicit Rules:
The first element in the first array, second in the second array, and third in the third will not change places
--diagonal line from [0][0] to [2][2]
...
Reassign the second and third values in the first array with the first value in the second and third array and vice versa
Reassign the third value at the second array with the second value at the third array
Return new matrix
...
def transpose(matrix)
  new_matrix = []
  matrix.each{|arr| new_matrix << arr.clone}
  new_matrix[0][1], new_matrix[0][2], new_matrix[1][0], new_matrix[2][0] = new_matrix[1][0], new_matrix[2][0], new_matrix[0][1], new_matrix[0][2]
  new_matrix[1][2], new_matrix[2][1] = new_matrix[2][1], new_matrix[1][2]
  new_matrix
end
