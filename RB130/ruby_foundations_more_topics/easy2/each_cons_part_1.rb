=begin
The Enumerable#each_cons method iterates over the members of a collection taking each sequence of n consecutive
elements at a time and passing them to the associated block for processing. It then returns a value of nil.
...
def each_cons(arr)
  arr.each_with_index{|v, idx| break if idx == (arr.size-1); yield(v, arr[idx+1])}
  nil
end
